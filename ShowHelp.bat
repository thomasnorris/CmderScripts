...
echo. && echo 7. Run "runbat" in an elevated cmd after install to run useful batch scripts and create shortcuts.
echo. && echo 8. The changelog is located at "Cmder\personal\changelog.md". Edit this with changes!
echo. && echo 9. Show this any time with "h".
exit /b 0